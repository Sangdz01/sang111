...
<style>
    ...
    <!-- breadcrumbs area start -->
		...
		<div class="product-details-area" id="content_product" data-id="{{ $proDetail->id }}">
			<div class="container">
				<div class="row">
							...
							<div role="tabpanel" class="tab-pane componet_rating col-md-offset-1" id="messages" style="margin-bottom: 20px">
								...
								<div class="form_rating hide">
									<div class="col-md-offset-1" style="display: flex; margin-top:15px; font-size: 15px">
										<p style="margin-bottom: 0">Your review</p>		
									...
									<div class="col-md-offset-1" style="margin-top: 15px">
										<a href="{{ route('post.rating.product', $proDetail->id) }}" class="js_rating_product" style="width: 200px; background: #288ad6;padding: 5px 10px; color: white;border-radius: 5px">Send the review</a>
									</div>
								</div>
							</div>
						</div>					
